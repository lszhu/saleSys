Template.storeTable.onCreated(function() {
  Session.set('storeTableSubmitErrors', {});
});

Template.storeTable.helpers({
  hasError: function(field) {
    return !!Session.get('storeTableSubmitErrors')[field] ? 'has-error' : '';
  },
  today: function() {
...
Template.storeTable.onRendered(function() {
...
Template.storeTable.events({
  'submit .createGrid': function(e) {
    ...
    Meteor.call('storeTable', query, function(err, result) {
      if (err) {
...
Template.storeGrid.onCreated(function () {
...
Template.storeGrid.onRendered(function() {
